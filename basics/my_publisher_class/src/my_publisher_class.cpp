...
namespace my_publisher_class
{
    MyPublisherClass::MyPublisherClass() : private_nh("~")
    {
        ...
        if(!nh.getParam("/my_publisher_class/param_int", param_int_nh_))     throw std::runtime_error("fail to get param_int_nh");
        ...
        std::cout << param_int_nh_ << " , " << param_float_ << " , " << param_string_ << std::endl;
